...
[Here](https://github.com/meganvanzyl/Honours_Blacktip_Project/blob/main/Code/Tidy%20Receiver%20Metadata%20Code/Receiver_GIS.R) is the clean R script for the metadata.

## Interactive Map of Receiver Stations along the East Coast

```{r}
#| label: Interactive GIS Map for Receiver Stations
#| include: false
library(tidyverse)
library(dplyr)
library(tidyr)
